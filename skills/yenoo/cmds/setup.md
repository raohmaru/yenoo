...
1. **Create** the vault folder structure:
  ...
  ```
2. **Create** the index, log and tags files:
  ```bash
  ...
  ```
3. **Insert** a `setup` entry to `log.md` with title "setup vault" and summary "Setup the folders and files of the vault"
4. **Validate** that the folder and file structure is created as per SKILL.md
5. **Report** results to the user: what was created.